 ...
 */
const VMGPPoolEntry *MVM_GetVmgpPoolEntry(const MVM_Instance_t *vm, uint32_t pool_index_1based);

/**
 * @brief Returns one decoded import name from the pool.
 */
const char *MVM_GetVmgpImportName(const MVM_Instance_t *vm, uint32_t pool_index_1based);
